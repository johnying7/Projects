...
OUT.uvcoords1.xy=0.0012*vectLength1+t1/10*wind_direction.xy*OUT.orgposz; //0.009
OUT.uvcoords2.xy=0.0009*vectLength2+t2/10*wind_direction.zw*OUT.orgposz; //0.004
